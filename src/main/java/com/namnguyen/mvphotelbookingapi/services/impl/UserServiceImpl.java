...
import com.namnguyen.mvphotelbookingapi.repository.UserRepository;
...
//    }
    ...
    public UserDTO findUserDTOByUsername(String username) {
        ...
        UserEntity user = userOptional.orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Username not found"));
...
//    }
    ...
    private UserDTO mapUserToUserDto(UserEntity user) {
